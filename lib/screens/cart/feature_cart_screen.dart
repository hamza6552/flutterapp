...
import '../store/storescreen2.dart';

class FeatureCartScreen extends StatefulWidget {
  static const routeName = '/cart-screen';
  const FeatureCartScreen({Key? key}) : super(key: key);

  @override
  State<FeatureCartScreen> createState() => _FeatureCartScreenState();
}

class _FeatureCartScreenState extends State<FeatureCartScreen> {
  var List1 = [];
  var main_list_cart = [];
  ...
  mergedata() async {
    ...
    for (var i = 0; i < main_list_cart.length; i++) {
      ...
      for (var j = 0; j < response.length; j++) {
        ...
        store_id = response[j]["store_id"].toString();
